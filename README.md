...
Phase 3 (✅ shipped, polish-batch): GitHub stats card, KST clock, Seoul weather widget, multilingual SoundConsent, FPS HUD. See the corresponding sub-tasks in the [jell-arcade S → AB polish history](https://github.com/jellive/jell-arcade#polish-history).
